...
var MessageBox = React.createClass({displayName: "MessageBox",
    ...
    render: function() {
        ...
        var message = this.state.messages.map(function(msg, i) {
            return React.createElement(SubMessage, {message: msg, key: i, onDelete: this.deleteMessage})
        }.bind(this));

        return (
            React.createElement("div", {className: "container jumbotron", style: inlineStyles},
                React.createElement("h2", null, this.state.titleMessage),
...
},{"./SubMessage":160,"react":158}],160:[function(require,module,exports){
var React = require('react');
...
},{"./MessageBox":159,"react":158,"react-dom":2}]},{},[161]);
